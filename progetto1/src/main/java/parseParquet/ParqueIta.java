...
public class ParqueIta {
    public static Iterator<Tuple2<String, Tuple3<Float,Float,Boolean>>> parseRow(Row line, int startingDay) {
        ...
        if(cov.getTampons()==-1){
            return Collections.<Tuple2<String,Tuple3<Float,Float,Boolean>>> emptyList().iterator();
        }else{

            return Arrays.asList(
                new Tuple2<>(
                        cov.toString(), //AnnoSettimana
